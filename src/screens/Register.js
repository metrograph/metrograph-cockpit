...
export default function Register() {
  ...
  function submitUser() {
    ...
    axios
      .post("http://157.90.233.37/v1/auth/register", inputs)
            ...
            <div className="flex flex-col my-auto">
              ...
              <div className="flex flex-col px-12">
                ...
                <div className="mt-12 flex justify-end">
                  <button
                    onClick={() => submitUser()}
                    className="bg-cock-green border-2 border-white h-10  space-x-2 px-6 hover:bg-green-400 cursor-pointer text-white text-xs font-Rajdhani font-bold"
                  >
                    CREATE USER
                  </button>
                </div>
